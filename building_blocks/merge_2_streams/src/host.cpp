...
//// INIT SORTED arrays ////
    float input_array_0[32] = {5, 12, 15, 17, 21, 24, 26, 26, 27, 30, 37, 41, 45, 45, 46, 46, 48,
       52, 55, 55, 59, 67, 68, 69, 86, 87, 91, 93, 94, 96, 97, 98};
    float input_array_1[32] = {9, 12, 16, 23, 24, 26, 26, 29, 42, 45, 47, 48, 49, 50, 51, 53, 53,
       55, 61, 61, 63, 63, 65, 72, 74, 74, 77, 79, 79, 82, 95, 98};
    // Complete Sorted Result
    // [5, 9, 12, 12, 15, 16, 17, 21, 23, 24, 24, 26, 26, 26, 26, 27, 29, 30, 37, 41, 42, 45, 45, 45, 46, 46, 47, 48, 48, 49, 50, 51, 52, 53, 53, 55, 55, 55, 59, 61, 61, 63, 63, 65, 67, 68, 69, 72, 74, 74, 77, 79, 79, 82, 86, 87, 91, 93, 94, 95, 96, 97, 98, 98]
    // First 32:
    // [5, 9, 12, 12, 15, 16, 17, 21, 23, 24, 24, 26, 26, 26, 26, 27, 29, 30, 37, 41, 42, 45, 45, 45, 46, 46, 47, 48, 48, 49, 50, 51]
    for (int i = 0; i < 32; i++) {
        DDR_embedding0[i] = input_array_0[i];
        DDR_embedding0[i + 32] = input_array_1[i];
    }
