...
#pragma HLS array_partition variable=input_array complete
    ...
    init_array<128>(input_array, table_HBM0);

    bitonic_sort(input_array);

    write_result<128>(input_array, out_PLRAM);
}
...
void bitonic_sort(float input_array[128]) {
    ...
    // Total: 7 stages, CC = 1 + ... + 7 = 28 CC
    // Stage 1
    compare_swap_range_interval<128, 64>(input_array);

    // Stage 2: 2 -> 4
    compare_swap_range_head_tail<128, 32>(input_array);
    compare_swap_range_interval<128, 64>(input_array);

    // Stage 3: 4 -> 8
    compare_swap_range_head_tail<128, 16>(input_array);
    compare_swap_range_interval<128, 32>(input_array);
    compare_swap_range_interval<128, 64>(input_array);

    // Stage 4: 8 -> 16
    compare_swap_range_head_tail<128, 8>(input_array);
    compare_swap_range_interval<128, 16>(input_array);
    compare_swap_range_interval<128, 32>(input_array);
    compare_swap_range_interval<128, 64>(input_array);
      
    // Stage 5: 16 -> 32
    compare_swap_range_head_tail<128, 4>(input_array);
    compare_swap_range_interval<128, 8>(input_array);
    compare_swap_range_interval<128, 16>(input_array);
    compare_swap_range_interval<128, 32>(input_array);
    compare_swap_range_interval<128, 64>(input_array);

    // Stage 6: 32 -> 64
    compare_swap_range_head_tail<128, 2>(input_array);
    compare_swap_range_interval<128, 4>(input_array);
    compare_swap_range_interval<128, 8>(input_array);
    compare_swap_range_interval<128, 16>(input_array);
    compare_swap_range_interval<128, 32>(input_array);
    compare_swap_range_interval<128, 64>(input_array);
    ...
    // Stage 7: 64 -> 128
    compare_swap_range_head_tail<128, 1>(input_array);
    compare_swap_range_interval<128, 2>(input_array);
    compare_swap_range_interval<128, 4>(input_array);
    compare_swap_range_interval<128, 8>(input_array);
    compare_swap_range_interval<128, 16>(input_array);
    compare_swap_range_interval<128, 32>(input_array);
