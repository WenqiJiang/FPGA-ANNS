...
//////////////////////////////   TEMPLATE END  //////////////////////////////
    ...
    int size_results_out = 32 * NUM_LOOP; 
...
//     float input_array[32] = {-3024, 7642, 2461, -6471, -83, 8758, -33, 4929, 1112, 3114, -5983, 
//         5649, -1940, -4604, -6878, -1526, -3117, 1732, 9219, -7029, 9277, 7612, -1048, -9208, 
//         9970, 7232, 8536, -4912, 7024, 7636, 9032, 3877};
        // Correct result: 
        // [-9208 -7029 -6878 -6471 -5983 -4912 -4604 -3117 -3024 -1940 -1526 -1048
        // -83   -33  1112  1732  2461  3114  3877  4929  5649  7024  7232  7612
        // 7636  7642  8536  8758  9032  9219  9277  9970]
    for (int i = 0; i < 32; i++) {
