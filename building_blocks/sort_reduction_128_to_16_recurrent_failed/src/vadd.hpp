...
template<const int input_len, const int output_len>
void sort_and_reduction(
    hls::stream<float> (&input_stream)[input_len],
    hls::stream<float> (&output_stream)[output_len]);
...
void sort_and_reduction_recurrent(
    hls::stream<float> (&input_stream)[input_len],
    hls::stream<float> (&final_smallest_stream)[output_len]);
