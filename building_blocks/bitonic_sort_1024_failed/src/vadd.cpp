...
#pragma HLS array_partition variable=input_array complete
    ...
    init_array<1024>(input_array, table_DDR0);

    bitonic_sort(input_array);

    write_result<1024>(input_array, out_PLRAM);
}
...
void bitonic_sort(float input_array[1024]) {
    // len = 32, np.random.randint(low=0, high=10000, size=1024)

    // Total: 15 sub-stages
    // Stage 1: 1 -> 2
    compare_swap_range_interval<1024, 512>(input_array);

    // Stage 2: 2 -> 4
    compare_swap_range_head_tail<1024, 256>(input_array);
    compare_swap_range_interval<1024, 512>(input_array);

    // Stage 3: 4 -> 8
    compare_swap_range_head_tail<1024, 128>(input_array);
    compare_swap_range_interval<1024, 256>(input_array);
    compare_swap_range_interval<1024, 512>(input_array);;

    // Stage 4: 8 -> 16
    compare_swap_range_head_tail<1024, 64>(input_array);
    compare_swap_range_interval<1024, 128>(input_array);
    compare_swap_range_interval<1024, 256>(input_array);
    compare_swap_range_interval<1024, 512>(input_array);
      
    // Stage 5: 16 -> 32
    compare_swap_range_head_tail<1024, 32>(input_array);
    compare_swap_range_interval<1024, 64>(input_array);
    compare_swap_range_interval<1024, 128>(input_array);
    compare_swap_range_interval<1024, 256>(input_array);
    compare_swap_range_interval<1024, 512>(input_array);

    // Stage6: 32 -> 64
    compare_swap_range_head_tail<1024, 16>(input_array);
    compare_swap_range_interval<1024, 32>(input_array);
    compare_swap_range_interval<1024, 64>(input_array);
    compare_swap_range_interval<1024, 128>(input_array);
    compare_swap_range_interval<1024, 256>(input_array);
    compare_swap_range_interval<1024, 512>(input_array);
    ...
    // Stage 7: 64 -> 128
    compare_swap_range_head_tail<1024, 8>(input_array);
    compare_swap_range_interval<1024, 16>(input_array);
    compare_swap_range_interval<1024, 32>(input_array);
    compare_swap_range_interval<1024, 64>(input_array);
    compare_swap_range_interval<1024, 128>(input_array);
    compare_swap_range_interval<1024, 256>(input_array);
    ...
    // Stage 8: 128 -> 256
    compare_swap_range_head_tail<1024, 4>(input_array);
    compare_swap_range_interval<1024, 8>(input_array);
    compare_swap_range_interval<1024, 16>(input_array);
    compare_swap_range_interval<1024, 32>(input_array);
    compare_swap_range_interval<1024, 64>(input_array);
    compare_swap_range_interval<1024, 128>(input_array);
    ...
    // Stage 9: 256 -> 512 
    compare_swap_range_head_tail<1024, 2>(input_array);
    compare_swap_range_interval<1024, 4>(input_array);
    compare_swap_range_interval<1024, 8>(input_array);
    compare_swap_range_interval<1024, 16>(input_array);
    compare_swap_range_interval<1024, 32>(input_array);
    compare_swap_range_interval<1024, 64>(input_array);
    ...
    // Stage 10: 512 -> 1024
    compare_swap_range_head_tail<1024, 1>(input_array);
    compare_swap_range_interval<1024, 2>(input_array);
    compare_swap_range_interval<1024, 8>(input_array);
    compare_swap_range_interval<1024, 16>(input_array);
    compare_swap_range_interval<1024, 32>(input_array);
    compare_swap_range_interval<1024, 64>(input_array);
