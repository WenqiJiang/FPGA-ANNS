...
#pragma HLS stream variable=s_merge_output depth=8
    ...
    merge_filter_streams<32>(s_merge_input_A, s_merge_input_B, s_merge_partial_output);
    result_redirect<32>(s_merge_partial_output, s_merge_input_B, s_merge_output); 
