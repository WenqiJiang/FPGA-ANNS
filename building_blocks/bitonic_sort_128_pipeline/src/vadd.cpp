...
#pragma HLS array_partition variable=output_stream dim=1
    ...
    broadcast_array<128>(table_HBM0, input_stream);

    bitonic_sort_128(input_stream, output_stream);
...
#pragma HLS array_partition variable=out_stage3_2 complete
    ...
    float out_stage4_0[128];
    float out_stage4_1[128];
    float out_stage4_2[128];
    float out_stage4_3[128];
...
#pragma HLS array_partition variable=out_stage4_3 complete
    ...
    float out_stage5_0[128];
    float out_stage5_1[128];
    float out_stage5_2[128];
    float out_stage5_3[128];
    float out_stage5_4[128];
...
#pragma HLS array_partition variable=out_stage5_4 complete
    ...
    float out_stage6_0[128];
    float out_stage6_1[128];
    float out_stage6_2[128];
    float out_stage6_3[128];
    float out_stage6_4[128];
    float out_stage6_5[128];
#pragma HLS array_partition variable=out_stage6_0 complete
#pragma HLS array_partition variable=out_stage6_1 complete
#pragma HLS array_partition variable=out_stage6_2 complete
#pragma HLS array_partition variable=out_stage6_3 complete
#pragma HLS array_partition variable=out_stage6_4 complete
#pragma HLS array_partition variable=out_stage6_5 complete


    float out_stage7_0[128];
    float out_stage7_1[128];
    float out_stage7_2[128];
    float out_stage7_3[128];
    float out_stage7_4[128];
    float out_stage7_5[128];
    float out_stage7_6[128];
#pragma HLS array_partition variable=out_stage7_0 complete
#pragma HLS array_partition variable=out_stage7_1 complete
#pragma HLS array_partition variable=out_stage7_2 complete
#pragma HLS array_partition variable=out_stage7_3 complete
#pragma HLS array_partition variable=out_stage7_4 complete
#pragma HLS array_partition variable=out_stage7_5 complete
#pragma HLS array_partition variable=out_stage7_6 complete

    for (int iter = 0; iter < SORT_ARRAY_NUM; iter++) {
#pragma HLS dataflow
        load_input_stream<128>(input_stream, input_array);
        // Total: 15 sub-stages
        // Stage 1
        compare_swap_range_interval<128, 64>(input_array, out_stage1_0);

        // Stage 2: 2 -> 4
        compare_swap_range_head_tail<128, 32>(out_stage1_0, out_stage2_0);
        compare_swap_range_interval<128, 64>(out_stage2_0, out_stage2_1);

        // Stage 3: 4 -> 8
        compare_swap_range_head_tail<128, 16>(out_stage2_1, out_stage3_0);
        compare_swap_range_interval<128, 32>(out_stage3_0, out_stage3_1);
        compare_swap_range_interval<128, 64>(out_stage3_1, out_stage3_2);

        // Stage 4: 8 -> 16
        compare_swap_range_head_tail<128, 8>(out_stage3_2, out_stage4_0);
        compare_swap_range_interval<128, 16>(out_stage4_0, out_stage4_1);
        compare_swap_range_interval<128, 32>(out_stage4_1, out_stage4_2);
        compare_swap_range_interval<128, 64>(out_stage4_2, out_stage4_3);
        
        // Stage 5: 16 -> 32
        compare_swap_range_head_tail<128, 4>(out_stage4_3, out_stage5_0);
        compare_swap_range_interval<128, 8>(out_stage5_0, out_stage5_1);
        compare_swap_range_interval<128, 16>(out_stage5_1, out_stage5_2);
        compare_swap_range_interval<128, 32>(out_stage5_2, out_stage5_3);
        compare_swap_range_interval<128, 64>(out_stage5_3, out_stage5_4);

        // Stage 6: 32 -> 64
        compare_swap_range_head_tail<128, 2>(out_stage5_4, out_stage6_0);
        compare_swap_range_interval<128, 4>(out_stage6_0, out_stage6_1);
        compare_swap_range_interval<128, 8>(out_stage6_1, out_stage6_2);
        compare_swap_range_interval<128, 16>(out_stage6_2, out_stage6_3);
        compare_swap_range_interval<128, 32>(out_stage6_3, out_stage6_4);
        compare_swap_range_interval<128, 64>(out_stage6_4, out_stage6_5);

        // Stage 7: 64 -> 128
        compare_swap_range_head_tail<128, 1>(out_stage6_5, out_stage7_0);
        compare_swap_range_interval<128, 2>(out_stage7_0, out_stage7_1);
        compare_swap_range_interval<128, 4>(out_stage7_1, out_stage7_2);
        compare_swap_range_interval<128, 8>(out_stage7_2, out_stage7_3);
        compare_swap_range_interval<128, 16>(out_stage7_3, out_stage7_4);
        compare_swap_range_interval<128, 32>(out_stage7_4, out_stage7_5);
        compare_swap_range_interval<128, 64>(out_stage7_5, out_stage7_6);

        write_output_stream<128>(out_stage7_6, output_stream);
    }
}
