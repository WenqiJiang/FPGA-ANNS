...
#pragma HLS pipeline II=1
                ...
                float result = 
                    temp_delayed.range(31, 0) +
                    temp_delayed.range(63, 32) +
                    temp_delayed.range(95, 64) +
                    temp_delayed.range(127, 96) +
                    temp_delayed.range(159, 128) +
                    temp_delayed.range(191, 160) +
                    temp_delayed.range(223, 192) +
                    temp_delayed.range(255, 224) +
                    temp_delayed.range(287, 256) +
                    temp_delayed.range(319, 288) +
                    temp_delayed.range(351, 320) +
                    temp_delayed.range(383, 352) +
                    temp_delayed.range(415, 384) +
                    temp_delayed.range(447, 416) +
                    temp_delayed.range(479, 448) +
                    temp_delayed.range(511, 480);
				dest.write(result);
			}
		}
	}
...
#pragma HLS pipeline II=1
                ...
                data_t result;
                result.range(31, 0) = temp_delayed;
                result.range(63, 32) = temp_delayed;
                result.range(95, 64) = temp_delayed;
                result.range(127, 96) = temp_delayed;
                result.range(159, 128) = temp_delayed;
                result.range(191, 160) = temp_delayed;
                result.range(223, 192) = temp_delayed;
                result.range(255, 224) = temp_delayed;
                result.range(287, 256) = temp_delayed;
                result.range(319, 288) = temp_delayed;
                result.range(351, 320) = temp_delayed;
                result.range(383, 352) = temp_delayed;
                result.range(415, 384) = temp_delayed;
                result.range(447, 416) = temp_delayed;
                result.range(479, 448) = temp_delayed;
                result.range(511, 480) = temp_delayed;
				dest[i] = result;
			}
		}
	}
