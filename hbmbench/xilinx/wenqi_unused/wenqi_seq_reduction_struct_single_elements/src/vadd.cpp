...
#pragma HLS pipeline II=1
            ...
            float result = 
                temp_delayed.items_0 + temp_delayed.items_1 + temp_delayed.items_2 +  
                temp_delayed.items_3 + temp_delayed.items_4 + temp_delayed.items_5 +  
                temp_delayed.items_6 + temp_delayed.items_7 + temp_delayed.items_8 +  
                temp_delayed.items_9 + temp_delayed.items_10 + temp_delayed.items_11 +  
                temp_delayed.items_12 + temp_delayed.items_13 + temp_delayed.items_14 +  
                temp_delayed.items_15;  
            dest.write(result);
        }
    }
}
