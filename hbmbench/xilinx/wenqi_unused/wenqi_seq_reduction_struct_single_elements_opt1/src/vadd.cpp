...
#pragma HLS pipeline II=1
            ...
            float partial_result0 = SUM_4(temp_delayed_cp0.items_0,
                temp_delayed_cp0.items_1, temp_delayed_cp0.items_2, temp_delayed_cp0.items_3);
            float partial_result1 = SUM_4(temp_delayed_cp1.items_4,
                temp_delayed_cp1.items_5, temp_delayed_cp1.items_6, temp_delayed_cp1.items_7);
            float partial_result2 = SUM_4(temp_delayed_cp2.items_8,
                temp_delayed_cp2.items_9, temp_delayed_cp2.items_10, temp_delayed_cp2.items_11);
            float partial_result3 = SUM_4(temp_delayed_cp3.items_12,
                temp_delayed_cp3.items_13, temp_delayed_cp3.items_14, temp_delayed_cp3.items_15);

            float result = SUM_4(partial_result0, partial_result1, partial_result2, partial_result3);
