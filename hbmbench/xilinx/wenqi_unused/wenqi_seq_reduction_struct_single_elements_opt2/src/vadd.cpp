...
#pragma HLS pipeline II=1
            ...
            float partial_result0_0 = SUM_2(temp_delayed_cp0.items_0, temp_delayed_cp0.items_1);
            float partial_result0_1 = SUM_2(temp_delayed_cp1.items_2, temp_delayed_cp1.items_3);
            float partial_result0_2 = SUM_2(temp_delayed_cp2.items_4, temp_delayed_cp2.items_5);
            float partial_result0_3 = SUM_2(temp_delayed_cp3.items_6, temp_delayed_cp3.items_7);
            float partial_result0_4 = SUM_2(temp_delayed_cp4.items_8, temp_delayed_cp4.items_9);
            float partial_result0_5 = SUM_2(temp_delayed_cp5.items_10, temp_delayed_cp5.items_11);
            float partial_result0_6 = SUM_2(temp_delayed_cp6.items_12, temp_delayed_cp6.items_13);
            float partial_result0_7 = SUM_2(temp_delayed_cp7.items_14, temp_delayed_cp7.items_15);
