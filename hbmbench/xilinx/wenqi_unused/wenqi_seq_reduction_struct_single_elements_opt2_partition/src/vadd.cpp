...
template<class T>
T SUM_4(T in0, T in1, T in2, T in3){
#pragma HLS pipeline
#pragma HLS inline off
#pragma HLS interface port=return register
...
// #pragma HLS data_pack variable=temp_delayed
#pragma HLS array_partition variable=temp_delayed dim=0 complete

            float items_0 = temp_delayed.items_0;
            float items_1 = temp_delayed.items_1;
            float items_2 = temp_delayed.items_2;
            float items_3 = temp_delayed.items_3;
            float items_4 = temp_delayed.items_4;
            float items_5 = temp_delayed.items_5;
            float items_6 = temp_delayed.items_6;
            float items_7 = temp_delayed.items_7;
            float items_8 = temp_delayed.items_8;
            float items_9 = temp_delayed.items_9;
            float items_10 = temp_delayed.items_10;
            float items_11 = temp_delayed.items_11;
            float items_12 = temp_delayed.items_12;
            float items_13 = temp_delayed.items_13;
            float items_14 = temp_delayed.items_14;
            float items_15 = temp_delayed.items_15;

            float partial_result0_0 = SUM_2(items_0, items_1);
            float partial_result0_1 = SUM_2(items_2, items_3);
            float partial_result0_2 = SUM_2(items_4, items_5);
            float partial_result0_3 = SUM_2(items_6, items_7);
            float partial_result0_4 = SUM_2(items_8, items_9);
            float partial_result0_5 = SUM_2(items_10, items_11);
            float partial_result0_6 = SUM_2(items_12, items_13);
            float partial_result0_7 = SUM_2(items_14, items_15);
