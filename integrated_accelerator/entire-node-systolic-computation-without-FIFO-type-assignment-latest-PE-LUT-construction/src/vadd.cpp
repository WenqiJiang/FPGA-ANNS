...
#pragma HLS dataflow
    ...
    hls::stream<float> s_query_vectors_LUT_construction_PE;
#pragma HLS stream variable=s_query_vectors_LUT_construction_PE depth=512
// #pragma HLS resource variable=s_query_vectors_LUT_construction_PE core=FIFO_BRAM

    hls::stream<float> s_query_vectors_coarse_distance_computation_PE[PE_NUM_CENTER_DIST_COMP];
#pragma HLS stream variable=s_query_vectors_coarse_distance_computation_PE depth=512
// #pragma HLS resource variable=s_query_vectors_coarse_distance_computation_PE core=FIFO_BRAM
#pragma HLS array_partition variable=s_query_vectors_coarse_distance_computation_PE complete

    load_query_vectors<QUERY_NUM>(
        HBM_query_vectors, 
        s_query_vectors_coarse_distance_computation_PE, 
        s_query_vectors_LUT_construction_PE);
...
// #pragma HLS resource variable=s_center_vectors_init_lookup_PE core=FIFO_SRL
    ...
    hls::stream<float> s_center_vectors_init_coarse_distance_computation_PE[PE_NUM_CENTER_DIST_COMP];
#pragma HLS stream variable=s_center_vectors_init_coarse_distance_computation_PE depth=8
#pragma HLS array_partition variable=s_center_vectors_init_coarse_distance_computation_PE complete
// #pragma HLS resource variable=s_center_vectors_init_coarse_distance_computation_PE core=FIFO_SRL

    load_center_vectors(
        HBM_vector_quantizer, 
        s_center_vectors_init_coarse_distance_computation_PE, 
        s_center_vectors_init_lookup_PE);

    hls::stream<float> s_product_quantizer_init;
#pragma HLS stream variable=s_product_quantizer_init depth=4
// #pragma HLS resource variable=s_product_quantizer_init core=FIFO_SRL
// #pragma HLS array_partition variable=s_product_quantizer_init complete
