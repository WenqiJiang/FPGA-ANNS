...
#pragma HLS pipeline II=1
        ...
        distance_LUT[0][((short) 256) + row_id] = dist_row.dist_8; 
        distance_LUT[1][((short) 256) + row_id] = dist_row.dist_9; 
        distance_LUT[2][((short) 256) + row_id] = dist_row.dist_10; 
        distance_LUT[3][((short) 256) + row_id] = dist_row.dist_11; 
        distance_LUT[4][((short) 256) + row_id] = dist_row.dist_12; 
        distance_LUT[5][((short) 256) + row_id] = dist_row.dist_13; 
        distance_LUT[6][((short) 256) + row_id] = dist_row.dist_14; 
        distance_LUT[7][((short) 256) + row_id] = dist_row.dist_15;
    }
}
...
#pragma HLS pipeline II=1
        ...
        out.dist = 
            ...
            distance_LUT[0][((short) 256) + PQ_local.PQ_code[8]] + 
            distance_LUT[1][((short) 256) + PQ_local.PQ_code[9]] + 
            distance_LUT[2][((short) 256) + PQ_local.PQ_code[10]] + 
            distance_LUT[3][((short) 256) + PQ_local.PQ_code[11]] + 
            distance_LUT[4][((short) 256) + PQ_local.PQ_code[12]] + 
            distance_LUT[5][((short) 256) + PQ_local.PQ_code[13]] + 
            distance_LUT[6][((short) 256) + PQ_local.PQ_code[14]] + 
            distance_LUT[7][((short) 256) + PQ_local.PQ_code[15]];
