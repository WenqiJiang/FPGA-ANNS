...
// #pragma HLS resource variable=s_query_vectors_LUT_construction_PE core=FIFO_BRAM
    ...
    hls::stream<float> s_query_vectors_coarse_distance_computation_PE;
...
// #pragma HLS resource variable=s_center_vectors_init_lookup_PE core=FIFO_SRL
    ...
    hls::stream<float> s_center_vectors_init_coarse_distance_computation_PE;
...
// #pragma HLS resource variable=s_center_vectors_init_coarse_distance_computation_PE core=FIFO_SRL
    ...
    hls::stream<float> s_product_quantizer_init[PE_NUM_TABLE_CONSTRUCTION];
...
#pragma HLS stream variable=s_cell_distance depth=256
// #pragma HLS resource variable=s_cell_distance core=FIFO_BRAM
