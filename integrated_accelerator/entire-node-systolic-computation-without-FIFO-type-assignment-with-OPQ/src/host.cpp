...
//////////////////////////////   TEMPLATE END  //////////////////////////////
    ...
    std::ifstream sw_result_vec_ID_fstream(
        "/mnt/scratch/wenqi/FPGA-ANNS/saved_npy_data/FPGA_data_SIFT100M_OPQ16,IVF8192,PQ16_HBM_21_banks/result_index_int32_10000_10_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream sw_result_dist_fstream(
        "/mnt/scratch/wenqi/FPGA-ANNS/saved_npy_data/FPGA_data_SIFT100M_OPQ16,IVF8192,PQ16_HBM_21_banks/result_distance_float32_10000_10_raw", 
        std::ios::in | std::ios::binary);
