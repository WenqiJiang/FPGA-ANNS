...
// 24 = 23 equal one + 1
#define PE_NUM_CENTER_DIST_COMP 24
#define PE_NUM_CENTER_DIST_COMP_EVEN 23
#define CENTROIDS_PER_PARTITION_EVEN 342
#define CENTROIDS_PER_PARTITION_LAST_PE 326

#define MERGE_ITER (NLIST/PE_NUM_CENTER_DIST_COMP) // the number of input sorted array (32 elements per partition)

// first 2 PE: construct 6 tables per query, last one construct 5
#define PE_NUM_TABLE_CONSTRUCTION 3
#define PE_NUM_TABLE_CONSTRUCTION_LARGER 2
#define PE_NUM_TABLE_CONSTRUCTION_SMALLER 1
#define NPROBE_PER_TABLE_CONSTRUCTION_PE_LARGER 6
#define NPROBE_PER_TABLE_CONSTRUCTION_PE_SMALLER 5
