...
//////////////////////////////   TEMPLATE END  //////////////////////////////
    ...
    std::ifstream sw_result_vec_ID_fstream(
        "/mnt/scratch/wenqi/FPGA-ANNS/saved_npy_data/FPGA_data_SIFT100M_OPQ16,IVF8192,PQ16_HBM_21_banks/result_nprobe_32_index_int32_10000_10_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream sw_result_dist_fstream(
        "/mnt/scratch/wenqi/FPGA-ANNS/saved_npy_data/FPGA_data_SIFT100M_OPQ16,IVF8192,PQ16_HBM_21_banks/result_nprobe_32_distance_float32_10000_10_raw", 
        std::ios::in | std::ios::binary);
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    OCL_CHECK(err, err = krnl_vector_add.setArg(25, buffer_HBM_OPQ_matrix));

    OCL_CHECK(err, err = krnl_vector_add.setArg(26, buffer_output));
