...
void split_cell_ID(
    ...
    hls::stream<ap_uint512_t>& s_result_searched_cell_ID,
    const int query_num);
...
void write_result(
    ...
    ap_uint512_t* results_out, const int query_num);


////////////////////     For integrated accelerator     ////////////////////   
...
#pragma HLS UNROLL factor=2
                ...
                distance_LUT_PQ16_t lookup_table_row;
                // square distance
                lookup_table_row.dist_0 = 
