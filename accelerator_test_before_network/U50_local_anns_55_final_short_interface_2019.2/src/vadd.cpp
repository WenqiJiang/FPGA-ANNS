...
#pragma HLS INTERFACE m_axi port=HBM_meta1  offset=slave bundle=gmem21
#pragma HLS INTERFACE m_axi port=HBM_meta2  offset=slave bundle=gmem22
#pragma HLS INTERFACE m_axi port=HBM_meta3  offset=slave bundle=gmem23
#pragma HLS INTERFACE m_axi port=HBM_meta4  offset=slave bundle=gmem24
#pragma HLS INTERFACE m_axi port=HBM_meta5  offset=slave bundle=gmem25
...
#pragma HLS INTERFACE s_axilite port=HBM_meta1  bundle=control
#pragma HLS INTERFACE s_axilite port=HBM_meta2  bundle=control
#pragma HLS INTERFACE s_axilite port=HBM_meta3  bundle=control
#pragma HLS INTERFACE s_axilite port=HBM_meta4  bundle=control
#pragma HLS INTERFACE s_axilite port=HBM_meta5  bundle=control
...
// // #pragma HLS resource variable=s_center_vectors_init_distance_computation_PE core=FIFO_SRL
    ...
    // load_center_vectors(HBM_meta3, s_center_vectors_init_distance_computation_PE, s_center_vectors_init_lookup_PE);
...
// #pragma HLS resource variable=s_PQ_quantizer_init core=FIFO_SRL
    ...
    load_PQ_quantizer(HBM_meta4, s_PQ_quantizer_init);
...
// #pragma HLS resource variable=s_OPQ_init core=FIFO_BRAM
    ...
    load_OPQ_matrix(HBM_meta5, s_OPQ_init);
