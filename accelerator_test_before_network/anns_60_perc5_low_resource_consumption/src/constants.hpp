...
#define PE_NUM_CENTER_DIST_COMP 8 //16
#define PE_NUM_CENTER_DIST_COMP_EVEN 7 // 15
...
#define PE_NUM_TABLE_CONSTRUCTION 2 // 9
#define PE_NUM_TABLE_CONSTRUCTION_LARGER 1 // 8
#define PE_NUM_TABLE_CONSTRUCTION_SMALLER 1
#define NPROBE_PER_TABLE_CONSTRUCTION_PE_LARGER 9 //2
#define NPROBE_PER_TABLE_CONSTRUCTION_PE_SMALLER 8 //1
