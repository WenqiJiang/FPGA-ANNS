...
template<const int query_num, const int stream_num, const int L1_queue_num>
...
// #pragma HLS RESOURCE variable=s_merged_intermediate_result_iter core=FIFO_SRL
    ...
    // const int L1_queue_num = 2 * HBM_CHANNEL_NUM;
    // const int L1_queue_num = 2 * stream_num;
    static Priority_queue<single_PQ_result, PRIORITY_QUEUE_LEN, Collect_smallest> priority_queue_intermediate[L1_queue_num];
