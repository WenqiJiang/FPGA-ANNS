...
namespace sort_reduction_32_to_16_with_vecID {
...
#pragma HLS UNROLL
    ...
    template<const int query_num, const int replicate_num>
...
template<> 
class Sort_reduction<single_PQ_result, 32, 16, Collect_smallest> {
...
// #pragma HLS RESOURCE variable=s_result_stage_0 core=FIFO_SRL
            ...
            hls::stream<int> s_control_iter_num_per_query_replicated[3];
...
#pragma HLS inline
            ...
            sort_reduction_32_to_16_with_vecID::replicate_s_control_iter_num_per_query<query_num, 3>(
                s_control_iter_num_per_query,
                s_control_iter_num_per_query_replicated); 

            for (int s = 0; s < 2; s++) {
#pragma HLS UNROLL
                sort_reduction_32_to_16_with_vecID::bitonic_sort_16<query_num>(
            ...
            sort_reduction_32_to_16_with_vecID::parallel_merge_sort_16<query_num>(
