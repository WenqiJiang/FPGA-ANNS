...
void generate_controller_input(
    int query_num,
    hls::stream<float>& s_query_vectors,
...
// #pragma HLS RESOURCE variable=s_scanned_entries_per_query_Priority_queue core=FIFO_BRAM
    ...
    scan_controller<QUERY_NUM, NLIST, NPROBE>(
        ...
        s_searched_cell_id_scan_controller, 
        s_start_addr_every_cell, // consume
        s_scanned_entries_every_cell_Load_unit, // use
        s_scanned_entries_every_cell_Split_unit, // consume
        s_scanned_entries_every_cell_PQ_lookup_computation, // consume
        s_scanned_entries_every_cell_Dummy, // consume
        s_last_valid_channel, // consume
