...
#define PE_NUM_CENTER_DIST_COMP 8
#define PE_NUM_CENTER_DIST_COMP_EVEN 7
...
#define NPROBE_PER_TABLE_CONSTRUCTION_PE_LARGER 9
#define NPROBE_PER_TABLE_CONSTRUCTION_PE_SMALLER 8
