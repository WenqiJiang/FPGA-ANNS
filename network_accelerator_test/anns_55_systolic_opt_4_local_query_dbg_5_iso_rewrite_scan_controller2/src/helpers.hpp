...
#pragma HLS pipeline II=1
    ...
    for (int query_id = 0; query_id < query_num; query_id++) {
        ...
        int scanned_entries_per_cell_buf[nprobe];
        ...
        for (int nprobe_id = 0; nprobe_id < nprobe; nprobe_id++) {
            ...
            scanned_entries_per_cell_buf[nprobe_id] = scanned_entries_every_cell;
        ...
        int accumulated_scanned_entries_per_query = 
            scanned_entries_per_cell_buf[0] + 
            scanned_entries_per_cell_buf[1] + 
            scanned_entries_per_cell_buf[2] + 
            scanned_entries_per_cell_buf[3] + 
            scanned_entries_per_cell_buf[4] + 
            scanned_entries_per_cell_buf[5] + 
            scanned_entries_per_cell_buf[6] + 
            scanned_entries_per_cell_buf[7] + 
            scanned_entries_per_cell_buf[8] + 
            scanned_entries_per_cell_buf[9] + 
            scanned_entries_per_cell_buf[10] + 
            scanned_entries_per_cell_buf[11] + 
            scanned_entries_per_cell_buf[12] + 
            scanned_entries_per_cell_buf[13] + 
            scanned_entries_per_cell_buf[14] + 
            scanned_entries_per_cell_buf[15] + 
            scanned_entries_per_cell_buf[16]; 
            ;
