...
#pragma HLS stream variable=s_result_buffer_HBM0 depth=128
#pragma HLS stream variable=s_result_buffer_HBM1 depth=128
#pragma HLS stream variable=s_result_buffer_HBM2 depth=128
#pragma HLS stream variable=s_result_buffer_HBM3 depth=128
#pragma HLS stream variable=s_result_buffer_HBM4 depth=128
#pragma HLS stream variable=s_result_buffer_HBM5 depth=128
#pragma HLS stream variable=s_result_buffer_HBM6 depth=128
#pragma HLS stream variable=s_result_buffer_HBM7 depth=128
#pragma HLS stream variable=s_result_buffer_HBM8 depth=128
#pragma HLS stream variable=s_result_buffer_HBM9 depth=128
#pragma HLS stream variable=s_result_buffer_HBM10 depth=128
#pragma HLS stream variable=s_result_buffer_HBM11 depth=128
#pragma HLS stream variable=s_result_buffer_HBM12 depth=128
#pragma HLS stream variable=s_result_buffer_HBM13 depth=128
#pragma HLS stream variable=s_result_buffer_HBM14 depth=128
#pragma HLS stream variable=s_result_buffer_HBM15 depth=128
#pragma HLS stream variable=s_result_buffer_HBM16 depth=128
#pragma HLS stream variable=s_result_buffer_HBM17 depth=128
#pragma HLS stream variable=s_result_buffer_HBM18 depth=128
#pragma HLS stream variable=s_result_buffer_HBM19 depth=128
#pragma HLS stream variable=s_result_buffer_HBM20 depth=128
#pragma HLS stream variable=s_result_buffer_HBM21 depth=128
#pragma HLS stream variable=s_result_buffer_HBM22 depth=128
#pragma HLS stream variable=s_result_buffer_HBM23 depth=128
#pragma HLS stream variable=s_result_buffer_HBM24 depth=128
#pragma HLS stream variable=s_result_buffer_HBM25 depth=128
#pragma HLS stream variable=s_result_buffer_HBM26 depth=128
#pragma HLS stream variable=s_result_buffer_HBM27 depth=128
// #pragma HLS stream variable=s_result_buffer_HBM28 depth=128
// #pragma HLS stream variable=s_result_buffer_HBM29 depth=128
// #pragma HLS stream variable=s_result_buffer_HBM30 depth=128
// #pragma HLS stream variable=s_result_buffer_HBM31 depth=128
...
void estimate_distance(
    ...
    #pragma HLS pipeline II = 1
        ...
        // unsigned char lookup_idx_A_0 = reg.PQ_code_A_0;
        // unsigned char lookup_idx_A_1 = reg.PQ_code_A_1;
        // unsigned char lookup_idx_A_2 = reg.PQ_code_A_2;
        // unsigned char lookup_idx_A_3 = reg.PQ_code_A_3;
        // unsigned char lookup_idx_A_4 = reg.PQ_code_A_4;
        // unsigned char lookup_idx_A_5 = reg.PQ_code_A_5;
        // unsigned char lookup_idx_A_6 = reg.PQ_code_A_6;
        // unsigned char lookup_idx_A_7 = reg.PQ_code_A_7;
        // unsigned char lookup_idx_A_8 = reg.PQ_code_A_8;
        // unsigned char lookup_idx_A_9 = reg.PQ_code_A_9;
        // unsigned char lookup_idx_A_10 = reg.PQ_code_A_10;
        // unsigned char lookup_idx_A_11 = reg.PQ_code_A_11;
        // unsigned char lookup_idx_A_12 = reg.PQ_code_A_12;
        // unsigned char lookup_idx_A_13 = reg.PQ_code_A_13;
        // unsigned char lookup_idx_A_14 = reg.PQ_code_A_14;
        // unsigned char lookup_idx_A_15 = reg.PQ_code_A_15;
        
        // unsigned char lookup_idx_B_0 = reg.PQ_code_B_0;
        // unsigned char lookup_idx_B_1 = reg.PQ_code_B_1;
        // unsigned char lookup_idx_B_2 = reg.PQ_code_B_2;
        // unsigned char lookup_idx_B_3 = reg.PQ_code_B_3;
        // unsigned char lookup_idx_B_4 = reg.PQ_code_B_4;
        // unsigned char lookup_idx_B_5 = reg.PQ_code_B_5;
        // unsigned char lookup_idx_B_6 = reg.PQ_code_B_6;
        // unsigned char lookup_idx_B_7 = reg.PQ_code_B_7;
        // unsigned char lookup_idx_B_8 = reg.PQ_code_B_8;
        // unsigned char lookup_idx_B_9 = reg.PQ_code_B_9;
        // unsigned char lookup_idx_B_10 = reg.PQ_code_B_10;
        // unsigned char lookup_idx_B_11 = reg.PQ_code_B_11;
        // unsigned char lookup_idx_B_12 = reg.PQ_code_B_12;
        // unsigned char lookup_idx_B_13 = reg.PQ_code_B_13;
        // unsigned char lookup_idx_B_14 = reg.PQ_code_B_14;
        // unsigned char lookup_idx_B_15 = reg.PQ_code_B_15;

        // unsigned char lookup_idx_C_0 = reg.PQ_code_C_0;
        // unsigned char lookup_idx_C_1 = reg.PQ_code_C_1;
        // unsigned char lookup_idx_C_2 = reg.PQ_code_C_2;
        // unsigned char lookup_idx_C_3 = reg.PQ_code_C_3;
        // unsigned char lookup_idx_C_4 = reg.PQ_code_C_4;
        // unsigned char lookup_idx_C_5 = reg.PQ_code_C_5;
        // unsigned char lookup_idx_C_6 = reg.PQ_code_C_6;
        // unsigned char lookup_idx_C_7 = reg.PQ_code_C_7;
        // unsigned char lookup_idx_C_8 = reg.PQ_code_C_8;
        // unsigned char lookup_idx_C_9 = reg.PQ_code_C_9;
        // unsigned char lookup_idx_C_10 = reg.PQ_code_C_10;
        // unsigned char lookup_idx_C_11 = reg.PQ_code_C_11;
        // unsigned char lookup_idx_C_12 = reg.PQ_code_C_12;
        // unsigned char lookup_idx_C_13 = reg.PQ_code_C_13;
        // unsigned char lookup_idx_C_14 = reg.PQ_code_C_14;
        // unsigned char lookup_idx_C_15 = reg.PQ_code_C_15;

        // unsigned char lookup_idx_D_0 = reg.PQ_code_D_0;
        // unsigned char lookup_idx_D_1 = reg.PQ_code_D_1;
        // unsigned char lookup_idx_D_2 = reg.PQ_code_D_2;
        // unsigned char lookup_idx_D_3 = reg.PQ_code_D_3;
        // unsigned char lookup_idx_D_4 = reg.PQ_code_D_4;
        // unsigned char lookup_idx_D_5 = reg.PQ_code_D_5;
        // unsigned char lookup_idx_D_6 = reg.PQ_code_D_6;
        // unsigned char lookup_idx_D_7 = reg.PQ_code_D_7;
        // unsigned char lookup_idx_D_8 = reg.PQ_code_D_8;
        // unsigned char lookup_idx_D_9 = reg.PQ_code_D_9;
        // unsigned char lookup_idx_D_10 = reg.PQ_code_D_10;
        // unsigned char lookup_idx_D_11 = reg.PQ_code_D_11;
        // unsigned char lookup_idx_D_12 = reg.PQ_code_D_12;
        // unsigned char lookup_idx_D_13 = reg.PQ_code_D_13;
        // unsigned char lookup_idx_D_14 = reg.PQ_code_D_14;
        // unsigned char lookup_idx_D_15 = reg.PQ_code_D_15;

        result_A = 
            distance_lookup_table_local_A_0[reg.PQ_code_A_0] + distance_lookup_table_local_A_1[reg.PQ_code_A_1] + 
            distance_lookup_table_local_A_2[reg.PQ_code_A_2] + distance_lookup_table_local_A_3[reg.PQ_code_A_3] + 
            distance_lookup_table_local_A_4[reg.PQ_code_A_4] + distance_lookup_table_local_A_5[reg.PQ_code_A_5] + 
            distance_lookup_table_local_A_6[reg.PQ_code_A_6] + distance_lookup_table_local_A_7[reg.PQ_code_A_7] + 
            distance_lookup_table_local_A_8[reg.PQ_code_A_8] + distance_lookup_table_local_A_9[reg.PQ_code_A_9] + 
            distance_lookup_table_local_A_10[reg.PQ_code_A_10] + distance_lookup_table_local_A_11[reg.PQ_code_A_11] + 
            distance_lookup_table_local_A_12[reg.PQ_code_A_12] + distance_lookup_table_local_A_13[reg.PQ_code_A_13] + 
            distance_lookup_table_local_A_14[reg.PQ_code_A_14] + distance_lookup_table_local_A_15[reg.PQ_code_A_15];

        result_B = 
            distance_lookup_table_local_B_0[reg.PQ_code_B_0] + distance_lookup_table_local_B_1[reg.PQ_code_B_1] + 
            distance_lookup_table_local_B_2[reg.PQ_code_B_2] + distance_lookup_table_local_B_3[reg.PQ_code_B_3] + 
            distance_lookup_table_local_B_4[reg.PQ_code_B_4] + distance_lookup_table_local_B_5[reg.PQ_code_B_5] + 
            distance_lookup_table_local_B_6[reg.PQ_code_B_6] + distance_lookup_table_local_B_7[reg.PQ_code_B_7] + 
            distance_lookup_table_local_B_8[reg.PQ_code_B_8] + distance_lookup_table_local_B_9[reg.PQ_code_B_9] + 
            distance_lookup_table_local_B_10[reg.PQ_code_B_10] + distance_lookup_table_local_B_11[reg.PQ_code_B_11] + 
            distance_lookup_table_local_B_12[reg.PQ_code_B_12] + distance_lookup_table_local_B_13[reg.PQ_code_B_13] + 
            distance_lookup_table_local_B_14[reg.PQ_code_B_14] + distance_lookup_table_local_B_15[reg.PQ_code_B_15];
        
        result_C = 
            distance_lookup_table_local_C_0[reg.PQ_code_C_0] + distance_lookup_table_local_C_1[reg.PQ_code_C_1] + 
            distance_lookup_table_local_C_2[reg.PQ_code_C_2] + distance_lookup_table_local_C_3[reg.PQ_code_C_3] + 
            distance_lookup_table_local_C_4[reg.PQ_code_C_4] + distance_lookup_table_local_C_5[reg.PQ_code_C_5] + 
            distance_lookup_table_local_C_6[reg.PQ_code_C_6] + distance_lookup_table_local_C_7[reg.PQ_code_C_7] + 
            distance_lookup_table_local_C_8[reg.PQ_code_C_8] + distance_lookup_table_local_C_9[reg.PQ_code_C_9] + 
            distance_lookup_table_local_C_10[reg.PQ_code_C_10] + distance_lookup_table_local_C_11[reg.PQ_code_C_11] + 
            distance_lookup_table_local_C_12[reg.PQ_code_C_12] + distance_lookup_table_local_C_13[reg.PQ_code_C_13] + 
            distance_lookup_table_local_C_14[reg.PQ_code_C_14] + distance_lookup_table_local_C_15[reg.PQ_code_C_15];
        
        result_D = 
            distance_lookup_table_local_D_0[reg.PQ_code_D_0] + distance_lookup_table_local_D_1[reg.PQ_code_D_1] + 
            distance_lookup_table_local_D_2[reg.PQ_code_D_2] + distance_lookup_table_local_D_3[reg.PQ_code_D_3] + 
            distance_lookup_table_local_D_4[reg.PQ_code_D_4] + distance_lookup_table_local_D_5[reg.PQ_code_D_5] + 
            distance_lookup_table_local_D_6[reg.PQ_code_D_6] + distance_lookup_table_local_D_7[reg.PQ_code_D_7] + 
            distance_lookup_table_local_D_8[reg.PQ_code_D_8] + distance_lookup_table_local_D_9[reg.PQ_code_D_9] + 
            distance_lookup_table_local_D_10[reg.PQ_code_D_10] + distance_lookup_table_local_D_11[reg.PQ_code_D_11] + 
            distance_lookup_table_local_D_12[reg.PQ_code_D_12] + distance_lookup_table_local_D_13[reg.PQ_code_D_13] + 
            distance_lookup_table_local_D_14[reg.PQ_code_D_14] + distance_lookup_table_local_D_15[reg.PQ_code_D_15];
    }
