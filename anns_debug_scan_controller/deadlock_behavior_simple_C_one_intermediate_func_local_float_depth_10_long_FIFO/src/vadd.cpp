...
#pragma HLS dataflow
    ...
    hls::stream<int> s_query_vectors;
#pragma HLS stream variable=s_query_vectors depth=4096
// #pragma HLS resource variable=s_query_vectors core=FIFO_BRAM

    hls::stream<int> s_control_send;
#pragma HLS stream variable=s_control_send depth=4096
...
#pragma HLS stream variable=s_results depth=4096
