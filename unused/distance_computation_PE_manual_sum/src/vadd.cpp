...
#pragma HLS stream variable=s_partial_cell_distance depth=4
    ...
    compute_cell_distance<QUERY_NUM>(s_centroid_vectors, s_query_vectors, s_partial_cell_distance);
    ...
    for (int query_id = 0; query_id < query_num; query_id++) {
        ...
        for (int c = 0; c < CENTROIDS_PER_PARTITION; c++) {
            ...
            // #pragma HLS UNROLL factor=16
                ...
                // TODO: Dataflow format
                // adding 16 floating point elements cannot be pipelined to II=1, 
                //   it ends up with II=3, thus here applies partial sum
                float partial_dist0 = sum_4(square_dist_0, square_dist_1, square_dist_2, square_dist_3);
                float partial_dist1 = sum_4(square_dist_4, square_dist_5, square_dist_6, square_dist_7);
                float partial_dist2 = sum_4(square_dist_8, square_dist_9, square_dist_10, square_dist_11);
                float partial_dist3 = sum_4(square_dist_12, square_dist_13, square_dist_14, square_dist_15);
                distance += sum_4(partial_dist0, partial_dist1, partial_dist2, partial_dist3); 
            }
