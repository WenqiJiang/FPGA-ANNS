...
//2097152 
    estimate_distance<1024>(table_HBM0, 0, s_result_buffer_HBM0);
    estimate_distance<1024>(table_HBM1, 0, s_result_buffer_HBM1);
    estimate_distance<1024>(table_HBM2, 0, s_result_buffer_HBM2);
    estimate_distance<1024>(table_HBM3, 0, s_result_buffer_HBM3);
    estimate_distance<1024>(table_HBM4, 0, s_result_buffer_HBM4);
    estimate_distance<1024>(table_HBM5, 0, s_result_buffer_HBM5);
    estimate_distance<1024>(table_HBM6, 0, s_result_buffer_HBM6);
    estimate_distance<1024>(table_HBM7, 0, s_result_buffer_HBM7);
    estimate_distance<1024>(table_HBM8, 0, s_result_buffer_HBM8);
    estimate_distance<1024>(table_HBM9, 0, s_result_buffer_HBM9);
    estimate_distance<1024>(table_HBM10, 0, s_result_buffer_HBM10);
    estimate_distance<1024>(table_HBM11, 0, s_result_buffer_HBM11);
    estimate_distance<1024>(table_HBM12, 0, s_result_buffer_HBM12);
    estimate_distance<1024>(table_HBM13, 0, s_result_buffer_HBM13);
    estimate_distance<1024>(table_HBM14, 0, s_result_buffer_HBM14);
    estimate_distance<1024>(table_HBM15, 0, s_result_buffer_HBM15);
    estimate_distance<1024>(table_HBM16, 0, s_result_buffer_HBM16);
    estimate_distance<1024>(table_HBM17, 0, s_result_buffer_HBM17);
    estimate_distance<1024>(table_HBM18, 0, s_result_buffer_HBM18);
    estimate_distance<1024>(table_HBM19, 0, s_result_buffer_HBM19);
    estimate_distance<1024>(table_HBM20, 0, s_result_buffer_HBM20);
    estimate_distance<1024>(table_HBM21, 0, s_result_buffer_HBM21);
    estimate_distance<1024>(table_HBM22, 0, s_result_buffer_HBM22);
    estimate_distance<1024>(table_HBM23, 0, s_result_buffer_HBM23);
    estimate_distance<1024>(table_HBM24, 0, s_result_buffer_HBM24);
    estimate_distance<1024>(table_HBM25, 0, s_result_buffer_HBM25);
    estimate_distance<1024>(table_HBM26, 0, s_result_buffer_HBM26);
    estimate_distance<1024>(table_HBM27, 0, s_result_buffer_HBM27);
    estimate_distance<1024>(table_HBM28, 0, s_result_buffer_HBM28);
    estimate_distance<1024>(table_HBM29, 0, s_result_buffer_HBM29);
    estimate_distance<1024>(table_HBM30, 0, s_result_buffer_HBM30);
    estimate_distance<1024>(table_HBM31, 0, s_result_buffer_HBM31);
}
...
void estimate_distance(
    ...
    unsigned char result_A = 0;
    unsigned char result_B = 0;
    unsigned char result_C = 0;
    unsigned char result_D = 0;
    ...
    #pragma HLS pipeline II = 1
        ...
        // result_A = 
        //     lookup_idx_A_0 + lookup_idx_A_1 + 
        //     lookup_idx_A_2 + lookup_idx_A_3 + 
        //     lookup_idx_A_4 + lookup_idx_A_5 + 
        //     lookup_idx_A_6 + lookup_idx_A_7 + 
        //     lookup_idx_A_8 + lookup_idx_A_9 + 
        //     lookup_idx_A_10 + lookup_idx_A_11 + 
        //     lookup_idx_A_12 + lookup_idx_A_13 + 
        //     lookup_idx_A_14 + lookup_idx_A_15;

        // result_B = 
        //     lookup_idx_B_0 + lookup_idx_B_1 + 
        //     lookup_idx_B_2 + lookup_idx_B_3 + 
        //     lookup_idx_B_4 + lookup_idx_B_5 + 
        //     lookup_idx_B_6 + lookup_idx_B_7 + 
        //     lookup_idx_B_8 + lookup_idx_B_9 + 
        //     lookup_idx_B_10 + lookup_idx_B_11 + 
        //     lookup_idx_B_12 + lookup_idx_B_13 + 
        //     lookup_idx_B_14 + lookup_idx_B_15;
        
        // result_C = 
        //     lookup_idx_C_0 + lookup_idx_C_1 + 
        //     lookup_idx_C_2 + lookup_idx_C_3 + 
        //     lookup_idx_C_4 + lookup_idx_C_5 + 
        //     lookup_idx_C_6 + lookup_idx_C_7 + 
        //     lookup_idx_C_8 + lookup_idx_C_9 + 
        //     lookup_idx_C_10 + lookup_idx_C_11 + 
        //     lookup_idx_C_12 + lookup_idx_C_13 + 
        //     lookup_idx_C_14 + lookup_idx_C_15;
        
        // result_D = 
        //     lookup_idx_D_0 + lookup_idx_D_1 + 
        //     lookup_idx_D_2 + lookup_idx_D_3 + 
        //     lookup_idx_D_4 + lookup_idx_D_5 + 
        //     lookup_idx_D_6 + lookup_idx_D_7 + 
        //     lookup_idx_D_8 + lookup_idx_D_9 + 
        //     lookup_idx_D_10 + lookup_idx_D_11 + 
        //     lookup_idx_D_12 + lookup_idx_D_13 + 
        //     lookup_idx_D_14 + lookup_idx_D_15;
    }

    // float result = (float) result_A + (float) result_B + (float) result_C + (float) result_D;
