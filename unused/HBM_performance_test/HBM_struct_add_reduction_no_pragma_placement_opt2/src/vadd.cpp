...
void load_HBM(const t_axi* HBM_bank, hls::stream<float> &s_output) {
    ...
    unsigned char distance_A, distance_B, distance_C, distance_D;
    ...
    for (int iter_num = 0; iter_num < 128; iter_num++) {
        ...
        // #pragma HLS pipeline II = 1
            ...
            reg = HBM_bank[idx];
            distance_A = 
                reg.PQ_code_A_0 + reg.PQ_code_A_1 + 
                reg.PQ_code_A_2 + reg.PQ_code_A_3 + 
                reg.PQ_code_A_4 + reg.PQ_code_A_5 + 
                reg.PQ_code_A_6 + reg.PQ_code_A_7 + 
                reg.PQ_code_A_8 + reg.PQ_code_A_9 + 
                reg.PQ_code_A_10 + reg.PQ_code_A_11 + 
                reg.PQ_code_A_12 + reg.PQ_code_A_13 + 
                reg.PQ_code_A_14 + reg.PQ_code_A_15;
            
            distance_B = 
                reg.PQ_code_B_0 + reg.PQ_code_B_1 + 
                reg.PQ_code_B_2 + reg.PQ_code_B_3 + 
                reg.PQ_code_B_4 + reg.PQ_code_B_5 + 
                reg.PQ_code_B_6 + reg.PQ_code_B_7 + 
                reg.PQ_code_B_8 + reg.PQ_code_B_9 + 
                reg.PQ_code_B_10 + reg.PQ_code_B_11 + 
                reg.PQ_code_B_12 + reg.PQ_code_B_13 + 
                reg.PQ_code_B_14 + reg.PQ_code_B_15;

            distance_C = 
                reg.PQ_code_C_0 + reg.PQ_code_C_1 + 
                reg.PQ_code_C_2 + reg.PQ_code_C_3 + 
                reg.PQ_code_C_4 + reg.PQ_code_C_5 + 
                reg.PQ_code_C_6 + reg.PQ_code_C_7 + 
                reg.PQ_code_C_8 + reg.PQ_code_C_9 + 
                reg.PQ_code_C_10 + reg.PQ_code_C_11 + 
                reg.PQ_code_C_12 + reg.PQ_code_C_13 + 
                reg.PQ_code_C_14 + reg.PQ_code_C_15;

            distance_D = 
                reg.PQ_code_D_0 + reg.PQ_code_D_1 + 
                reg.PQ_code_D_2 + reg.PQ_code_D_3 + 
                reg.PQ_code_D_4 + reg.PQ_code_D_5 + 
                reg.PQ_code_D_6 + reg.PQ_code_D_7 + 
                reg.PQ_code_D_8 + reg.PQ_code_D_9 + 
                reg.PQ_code_D_10 + reg.PQ_code_D_11 + 
                reg.PQ_code_D_12 + reg.PQ_code_D_13 + 
                reg.PQ_code_D_14 + reg.PQ_code_D_15;
        }
    }

    // float out = (float) reg.PQ_code_A_0;
    float out = (float) distance_A + (float) distance_B + (float) distance_C + (float) distance_D;
    s_output.write(out);
}
