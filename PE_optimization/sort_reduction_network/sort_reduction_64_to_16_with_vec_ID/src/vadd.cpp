...
#pragma HLS array_partition variable=input_array_B complete
    ...
    single_PQ_result out_stage_0[128];
    single_PQ_result out_stage_1[128];
    single_PQ_result out_stage_2[128];
    single_PQ_result out_stage_3[128];
    single_PQ_result out_stage_4[128];
...
//     hls::stream<float> (&sorted_stream[16]), hls::stream<float> &output_stream) {
...
//     Priority_queue<single_PQ_result, PRIORITY_QUEUE_LEN, Collect_smallest> pq[20];

//     pq.insert_wrapper<STREAM_LEN>(s_input, s_output);
// }
