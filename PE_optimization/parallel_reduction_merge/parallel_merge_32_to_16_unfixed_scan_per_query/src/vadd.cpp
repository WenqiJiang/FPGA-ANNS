...
#pragma HLS RESOURCE variable=s_output core=FIFO_SRL
    ...
    hls::stream<int> s_control_iter_num_per_query[4];
...
////////////////////     Core Function Ends     ////////////////////
    ...
    write_result<QUERY_NUM>(
        s_control_iter_num_per_query[3],
        s_output,
        out_PLRAM);
}
...
void control_signal_sender(
    ...
    for (int query_id = 0; query_id < query_num; query_id++) {
        ...
        s_control_iter_num_per_query[3].write(iteration_per_query);
    }
}
