...
The resource consumption of this module is very low, thus recommend using the unroll factor 8 version because it should deliver enough performance for any index setting (50K+ QPS).
...
|Expression           |        -|     -|        0|      204|    -|
|FIFO                 |        -|     -|        -|        -|    -|
|Instance             |        -|    40|     2872|     2514|    -|
|Memory               |       33|     -|      512|       64|    -|
|Multiplexer          |        -|     -|        -|      503|    -|
|Register             |        -|     -|     1746|      256|    -|
+---------------------+---------+------+---------+---------+-----+
|Total                |       33|    40|     5130|     3541|    0|
+---------------------+---------+------+---------+---------+-----+
