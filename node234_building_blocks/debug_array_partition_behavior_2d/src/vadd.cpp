...
void PQ_lookup_computation(
    ...
    float distance_lookup_table_local[8][512];
...
#pragma HLS pipeline II=1
        ...
        out.dist = 
            distance_lookup_table_local[0][PQ_local.PQ_code[0]] + distance_lookup_table_local[1][PQ_local.PQ_code[1]] + 
            distance_lookup_table_local[2][PQ_local.PQ_code[2]] + distance_lookup_table_local[3][PQ_local.PQ_code[3]] + 
            distance_lookup_table_local[4][PQ_local.PQ_code[4]] + distance_lookup_table_local[5][PQ_local.PQ_code[5]] + 
            distance_lookup_table_local[6][PQ_local.PQ_code[6]] + distance_lookup_table_local[7][PQ_local.PQ_code[7]] + 

            distance_lookup_table_local[0][((int)PQ_local.PQ_code[8]) + 256] + 
            distance_lookup_table_local[1][((int)PQ_local.PQ_code[9]) + 256] + 
            distance_lookup_table_local[2][((int)PQ_local.PQ_code[10]) + 256] + 
            distance_lookup_table_local[3][((int)PQ_local.PQ_code[11]) + 256] + 
            distance_lookup_table_local[4][((int)PQ_local.PQ_code[12]) + 256] + 
            distance_lookup_table_local[5][((int)PQ_local.PQ_code[13]) + 256] + 
            distance_lookup_table_local[6][((int)PQ_local.PQ_code[14]) + 256] + 
            distance_lookup_table_local[7][((int)PQ_local.PQ_code[15]) + 256];
        // out.dist = 
