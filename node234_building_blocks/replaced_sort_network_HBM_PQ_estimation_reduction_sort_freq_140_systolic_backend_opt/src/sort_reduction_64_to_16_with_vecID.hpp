...
#pragma HLS inline
        ...
        // bitonic sort input
        single_PQ_result bitonic_sort_input_array[4][16];
#pragma HLS array_partition variable=bitonic_sort_input_array complete

        // bitonic sort output / parallel merging input
        single_PQ_result bitonic_sort_out_stage4_3[4][16];
#pragma HLS array_partition variable=bitonic_sort_out_stage4_3 complete

        // parallel merge level A output / parallel merge level B input
        single_PQ_result parallel_merge_level_A_out_stage_4[2][16];
#pragma HLS array_partition variable=parallel_merge_level_A_out_stage_4 complete

        // parallel merge level B output
        single_PQ_result parallel_merge_level_B_out_stage_4[16];
#pragma HLS array_partition variable=parallel_merge_level_B_out_stage_4 complete
