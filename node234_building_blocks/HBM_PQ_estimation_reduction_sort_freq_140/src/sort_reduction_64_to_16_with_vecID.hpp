...
#pragma HLS dataflow
            ...
            for (int i = 0; i < 4; i++) {
#pragma HLS UNROLL
                sort_reduction_64_to_16_with_vecID::bitonic_sort_16<iter_num>(input_stream[i], result_stage_0[i]);
            }

            for (int i = 0; i < 2; i++) {
#pragma HLS UNROLL
                sort_reduction_64_to_16_with_vecID::parallel_merge_sort_16<iter_num>(
