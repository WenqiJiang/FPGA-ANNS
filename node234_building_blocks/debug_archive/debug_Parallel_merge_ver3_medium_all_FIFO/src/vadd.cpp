...
#pragma HLS stream variable=s_scanned_cell_id depth=8
#pragma HLS RESOURCE variable=s_scanned_cell_id core=FIFO_SRL

    hls::stream<int> s_scanned_entries_every_cell_Dummy[32];
#pragma HLS stream variable=s_scanned_entries_every_cell_Dummy depth=8
...
#pragma HLS stream variable=s_scanned_entries_per_query_Sort_and_reduction depth=8
...
#pragma HLS stream variable=s_scanned_entries_per_query_Result depth=8
