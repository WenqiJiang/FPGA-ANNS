...
#pragma HLS array_partition variable=input_array_B complete
        ...
        // TODO! Here is different to original code, which has a length of 128 instead of 16
...
#pragma HLS array_partition variable=result_stage_1 complete
            ...
            hls::stream<int> control_stream_iter_num_per_query_replicated[7];
#pragma HLS stream variable=control_stream_iter_num_per_query_replicated depth=2
#pragma HLS array_partition variable=control_stream_iter_num_per_query_replicated dim=1 complete
