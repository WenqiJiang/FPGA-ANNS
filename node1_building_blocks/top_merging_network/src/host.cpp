...
//// INIT SORTED arrays ////
    // MERGE_ITER = 8, the following array are 8 sorted arrays, each with 32 elements
    float input_array[32 * MERGE_ITER] = {
       8,  36,  38,  60,  95, 144, 151, 161, 269, 334, 390, 414, 430,
       452, 498, 509, 535, 543, 650, 661, 723, 734, 801, 802, 816, 820,
       846, 887, 889, 899, 916, 939, 

       16,  42,  74, 123, 124, 184, 198, 210, 217, 234, 275, 333, 443,
       458, 480, 497, 600, 646, 653, 681, 699, 706, 769, 772, 841, 862,
       864, 878, 912, 914, 918, 930, 

       22,  51,  84, 101, 142, 178, 228, 237, 250, 268, 271, 279, 304,
       370, 378, 403, 423, 459, 464, 489, 490, 584, 622, 720, 738, 784,
       803, 873, 916, 917, 978, 986, 

       35, 185, 209, 223, 232, 255, 275, 282, 332, 342, 388, 456, 516,
       559, 571, 607, 608, 663, 670, 683, 692, 730, 747, 795, 843, 864,
       880, 905, 934, 942, 948, 967, 

       7,   7,  11,  14,  42,  49,  55, 122, 226, 291, 327, 435, 436,
       461, 483, 508, 561, 608, 626, 689, 690, 711, 720, 747, 785, 791,
       831, 838, 912, 919, 920, 932, 

       91, 124, 164, 214, 223, 226, 241, 271, 277, 333, 410, 420, 420,
       489, 493, 513, 533, 534, 568, 571, 679, 691, 691, 703, 763, 770,
       825, 876, 881, 936, 939, 948, 

       77,  79, 101, 123, 176, 200, 220, 234, 236, 255, 275, 316, 332,
       364, 383, 481, 518, 559, 562, 607, 635, 695, 719, 735, 746, 753,
       781, 807, 839, 905, 983, 986, 

       12,  30, 121, 184, 213, 226, 256, 291, 311, 339, 343, 385, 399,
       430, 462, 467, 472, 495, 509, 519, 537, 591, 641, 652, 731, 746,
       770, 792, 818, 827, 852, 955
    };
    // the true smallest 32 numbers:
    // 7, 7, 8, 11, 12, 14, 16, 22, 30, 35, 36, 38, 42, 42, 49, 51, 55, 60, 74, 77, 
    //   79, 84, 91, 95, 101, 101, 121, 122, 123, 123, 124, 124]
    for (int i = 0; i < MERGE_LEN * PE_NUM_SORT_MERGE; i++) {
