...
#pragma HLS stream variable=s_merge_output depth=8
    ...
    broadcast_stream<MERGE_LEN * MERGE_ITER, PE_NUM_DIST_COMP, QUERY_NUM>(table_DDR0, s_input_stream);
...
void broadcast_stream(const float* data_source,
    ...
    // given 8192 distance values from DRAM, simulate the situation that
