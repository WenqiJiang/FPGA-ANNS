...
const int s_input_stream_depth = 1;
const int s_result_stage1_depth = 2;
const int s_result_stage2_depth = 4;
const int s_result_stage3_depth = 8;
const int s_result_stage4_depth = 16;
const int s_result = 32;